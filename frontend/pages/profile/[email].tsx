...
const ProfilePage: React.FC<ProfileProps> = ({ user }) => {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleDeleteAddressSubmit}>
        <div>
          <label>
            Address Index:
            <input
      ...
      <form onSubmit={handleEditCreditCardSubmit}>
        <div>
          <label>
            Credit Card Index:
            <input
        ...
        <div>
          <button type="submit">Edit Credit Card</button>
        </div>
      </form>

      <h2>Delete Credit Card</h2>
      <form onSubmit={handleDeleteCreditCardSubmit}>
        <div>
          <label>
            Credit Card Index:
            <input
