...
<main className={styles.container}>
  ...
  <div className={styles.cartAndReviewsContainer}>
    <div className={styles.addToCart}>
      ...
      <label>
        Purchase Option:
        <select value={purchaseOption} onChange={(e) => setPurchaseOption(e.target.value)} className={styles.selectInput}>
        ...
        <div className={styles.customizations}>
          ...
          {product.customizableOptions.map((option) => (
            <label key={option.label}>
              {option.label}:
              <select
                onChange={(e) => setCustomizations((prev) => ({ ...prev, [option.label]: e.target.value }))}
